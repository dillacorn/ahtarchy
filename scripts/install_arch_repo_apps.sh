...
if [[ "$choice" == "y" || "$choice" == "Y" ]]; then
    ...
    for pkg in hyprland hyprpaper hyprlock hypridle waybar wofi rofi-wayland swww grim satty slurp wl-clipboard zbar wf-recorder zenity qt5-wayland qt6-wayland xdg-desktop-portal-hyprland xdg-desktop-portal-gtk mako nwg-look; do
        install_package "$pkg"
    done
