...
declare -a pkg_groups=(
    ...
    "Terminal Apps:nano micro alacritty fastfetch btop htop curl wget git dos2unix brightnessctl ipcalc cmatrix sl asciiquarium figlet cava man-db man-pages unzip xarchiver ncdu ddcutil"
