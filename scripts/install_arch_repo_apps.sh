...
if [[ "$choice" == "y" || "$choice" == "Y" ]]; then
    ...
    for pkg in steam polkit-kde-agent lxappearance networkmanager network-manager-applet tailscale bluez bluez-utils blueman pavucontrol nemo gvfs gvfs-smb gvfs-mtp gvfs-afc qbittorrent filelight timeshift imagemagick pipewire pipewire-pulse pipewire-alsa ufw; do
        install_package "$pkg"
    done
