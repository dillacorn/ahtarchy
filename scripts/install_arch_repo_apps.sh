...
if [[ "$choice" == "y" || "$choice" == "Y" ]]; then
    ...
    for pkg in hyprland hyprpaper hyprlock hypridle waybar wlogout rofi-wayland swww grim slurp wl-clipboard qt5-wayland qt6-wayland xdg-desktop-portal-hyprland xdg-desktop-portal-gtk mako nwg-look; do
        install_package "$pkg"
    done
